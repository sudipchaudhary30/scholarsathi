  ...
  <div>
    ...
    <section className="animated-gallery">
      ...
      <div className="gallery-images">
        <img src="/assets/softwarica logo.png" alt="Campus View 1" className="animated-image fade-in-left" />
        <img src="/assets/softwarica logo.png" alt="Campus View 2" className="animated-image fade-in-up" />
        <img src="/assets/softwarica logo.png" alt="University Event" className="animated-image fade-in-right" />
      </div>
    </section>
